...
urlpatterns = [
    ...
    path("p/<slug:slug>/duplicatas/mesclar/", views.mesclar_duplicata_view, name="triagem_duplicata_mesclar"),
    path("p/<slug:slug>/duplicatas/descartar/", views.descartar_duplicata_view, name="triagem_duplicata_descartar"),
