...
ITENS = [
    ...
    (
        ...
        "Pergunta de pesquisa do protocolo.",
        "triagem_protocolo",
        False,
    ),
    (
        ...
        "Protocolo versionado + registro externo (OSF).",
        "triagem_protocolo",
        False,
    ),
    (
        ...
        "Critérios de inclusão/exclusão + filtros (período, idiomas, tipos).",
        "triagem_protocolo",
        False,
    ),
    (
    ...
    (
        ...
        "String de busca + filtros por importação.",
        "triagem_painel",
        False,
    ),
    (
        ...
        "Triagem por ≥2 revisores independentes, consenso/desempate, concordância (κ).",
        "triagem_prisma",
        False,
    ),
    (
    ...
    (
        ...
        "Campos da Matriz AnCo (objeto, objetivo, foco, epistemologia, teoria…).",
        None,
        False,
    ),
    (
        ...
        "Opcional em revisões de escopo.",
        None,
        True,
    ),
    (
        ...
        "Acervo + estatísticas + busca facetada/semântica.",
        "pagina_estatisticas",
        False,
    ),
    (
    ...
    (
        ...
        "Páginas das análises (citação ABNT/APA).",
        None,
        False,
    ),
    (
    ...
    (
        ...
        "Cada análise publicada no acervo.",
        None,
        False,
    ),
    (
